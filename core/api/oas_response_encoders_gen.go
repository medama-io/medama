...
func encodeGetSettingsUsageResponse(response GetSettingsUsageRes, w http.ResponseWriter) error {
	switch response := response.(type) {
...
func encodePatchSettingsUsageResponse(response PatchSettingsUsageRes, w http.ResponseWriter) error {
	switch response := response.(type) {
	case *PatchSettingsUsageCreated:
		w.WriteHeader(201)
