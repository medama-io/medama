...
func (s *Server) decodePatchSettingsUsageRequest(r *http.Request) (
	req *SettingsUsagePatch,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request SettingsUsagePatch
		if err := func() error {
